...
samtools index ../../../BamFiles/Sample_In_merged.sorted.bam
samtools index ../../../BamFiles/Sample_27Ac_1.sorted.bam
samtools index ../../../BamFiles/Sample_27Ac_2.sorted.bam
samtools index ../../../BamFiles/Sample_27Ac_merged.sorted.bam

###make bed file. It just needs a .bed extension
mv ../../../out/Callpeak/Broadpeak/Sample_27Ac_1_filt_peaks.broadPeak ../../../out/Callpeak/Broadpeak/Sample_27Ac_1_filt_peaks.bed
mv ../../../out/Callpeak/Broadpeak/Sample_27Ac_2_filt_peaks.broadPeak ../../../out/Callpeak/Broadpeak/Sample_27Ac_2_filt_peaks.bed
mv ../../../out/Callpeak/Broadpeak/Sample_27Ac_merged_filt_peaks.broadPeak ../../../out/Callpeak/Broadpeak/Sample_27Ac_merged_filt_peaks.bed
###Run the main ROSE2 program
python ROSE2_main.py -g HG19 -i ../../../out/Callpeak/Broadpeak/Sample_27Ac_1_filt_peaks.bed -r ../../../BamFiles/Sample_27Ac_1.sorted.bam -c ../../../BamFiles/Sample_In_merged.sorted.bam -o ../../../out/ROSE2 -t 2500 -s 12500
